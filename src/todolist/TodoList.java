...
public class TodoList {
     ...
     */
    public void addTask(String title, String project, String taskDescription,String ld, LocalDate dueDate) {
    ...
    public boolean readTaskFromUser() {
        ...
        try {
            ...
            System.out.print("Выбор периодичности задачи [[example:\\\"Однократная\\\",\\\"Ежедневная\\\",\\\"Еженедельная\\\",\\\"Ежемесячная\\\",\\\"Ежегодная\\\"] : \"] : ");
    ...
    public void listAllTasksWithIndex() {
        String displayFormat = "%-4s %-15s %-15s %-15s %-15s %-10s";
        ;
    ...
    public void listAllTasks(String sortBy) {
        ...
        if (sortBy.equals("2")) {
            String displayFormat = "%-15s %-15s %-10s %-15s %-25s %-10s";
            ...
            String displayFormat = "%-15s %-15s %-10s %-15s %-25s %-15s";
