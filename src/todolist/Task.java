...
public class Task implements Serializable {
    public class FrequencyTask  {
       ...
       public static FrequencyTask ONETIME = null;
        public static FrequencyTask DAILY = null;
        public static FrequencyTask WEEKLY = null;
        public static FrequencyTask MONTHLY = null;
        public static FrequencyTask ANNUAL = null;
        private static FrequencyTask[] VALUES = new FrequencyTask[5];

        protected FrequencyTask(String name, int ordinal) {
           name=name;
           ordinal=ordinal;
        ...
        {
            ONETIME = new FrequencyTask("Однократная", 0);
            DAILY = new FrequencyTask("Ежедневная", 1);
            WEEKLY = new FrequencyTask("Еженедельная", 2);
            MONTHLY = new FrequencyTask("Ежемесячная", 3);
            ANNUAL = new FrequencyTask("Ежегодная", 4);

            VALUES = new FrequencyTask[]{ONETIME, DAILY, WEEKLY, MONTHLY,ANNUAL};
        }

        public static FrequencyTask[] values() {
            return VALUES.clone();
        }

        public FrequencyTask[] valueOf(String name) {
            return FrequencyTask.values();
        }
    }
    ...
    private String ld = String.valueOf(FrequencyTask.values());
    ...
    public Task(String title, String project,String taskDescription,String ld, LocalDate dueDate) {
    ...
    /**
     // Способ задать периодичности задачи
    ...
    /**
     // Способ получения периодичности задачи
     //возвращает строку, содержащую название задачи
     */
